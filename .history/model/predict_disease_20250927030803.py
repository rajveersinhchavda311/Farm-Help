...
# --- The rest of your file is the same until the very end ---
...
try:
    ...
    sys.exit(1) # This exit is ok, it happens on startup
...
def main():
    ...
    try:
        # ... (the main try block logic is unchanged)
        ...
        # --- THIS IS THE CHANGE ---
        # We now print the error as JSON and let the script exit normally
        print(json.dumps({"error": str(e)}))
        # sys.exit(1) <-- We have removed this line
