...
const makePrediction = async (req, res) => {
    ...
    try {
        ...
        const options = {
            mode: 'json',
            // IMPORTANT: Replace the placeholder below with the path you found on your system.
            // Remember to use double backslashes (\\) on Windows.
            pythonPath: 'C:\Users\mohit\aptos_env\Lib\site-packages\sympy\printing\\python.exe', // e.g., 'C:\\Users\\mohit\\AppData\\Local\\Programs\\Python\\Python39\\python.exe'
        };
        // -----------------------------------------------------------
